...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-orange-50 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
          ...
          >
            <button className="px-8 py-4 bg-purple-600 text-white rounded-full font-semibold hover:bg-purple-700 transition-colors flex items-center gap-2">
              Start Technology
              <ArrowRight className="w-4 h-4" />
            </button>
            <button className="px-8 py-4 bg-white text-gray-900 rounded-full font-semibold border border-gray-200 hover:bg-gray-50 transition-colors">
              About Team
            </button>
          </motion.div>
          ...
          >
            <motion.div variants={fadeInUp} className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-gray-900 mb-2">160+</div>
              <div className="text-gray-600">Development approaches created</div>
              <div className="text-sm text-gray-500 mt-1">To facilitate better integration and improved user experience during development</div>
            </motion.div>
            <motion.div variants={fadeInUp} className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-gray-900 mb-2">1.8M</div>
              <div className="text-gray-600">Lines of code written</div>
            </motion.div>
            <motion.div variants={fadeInUp} className="text-center">
              <div className="text-4xl md:text-5xl font-bold text-gray-900 mb-2">196+</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <div className="text-purple-600 font-semibold text-sm uppercase tracking-wider">Our Story</div>
              ...
              <button className="inline-flex items-center px-6 py-3 bg-gray-900 text-white rounded-full font-semibold hover:bg-gray-800 transition-colors">
                Start Technology
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-3xl font-bold text-gray-900">$18,124</span>
                    <span className="px-3 py-1 bg-purple-100 text-purple-600 rounded-full text-sm font-medium">Shop</span>
                  </div>
                  <p className="text-gray-600">Total revenue generated for our clients in the last quarter through innovative solutions.</p>
                  <div className="flex items-center space-x-2">
                    <div className="flex -space-x-2">
                      ...
                      <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=32&h=32&fit=crop&crop=face" alt="User" className="w-8 h-8 rounded-full border-2 border-white" />
                    </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <div className="text-purple-600 font-semibold text-sm uppercase tracking-wider mb-4">Our Values</div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Core values of payix</h2>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <motion.div variants={fadeInUp} className="text-center p-8 bg-white rounded-3xl shadow-lg">
              <div className="w-16 h-16 bg-purple-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <DollarSign className="w-8 h-8 text-purple-600" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">Core values of payix</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <div className="text-purple-600 font-semibold text-sm uppercase tracking-wider mb-4">Our Team</div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">From our team to yours</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="bg-gray-50 rounded-3xl p-8">
                <div className="text-4xl font-bold text-gray-900 mb-2">45 hours</div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
                ...
                />
                <div className="text-2xl font-bold text-gray-900 mb-2">75% Faster</div>
                <p className="text-gray-600">
          ...
          >
            {[
              ...
              <motion.div 
                key={index}
                variants={fadeInUp}
                className="bg-white rounded-3xl p-6 shadow-lg text-center hover:shadow-xl transition-shadow"
              >
                <img 
                  src={member.image} 
                  alt={member.name}
                ...
                <div className="flex justify-center space-x-3">
                  <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-purple-100 cursor-pointer transition-colors">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <div className="text-purple-600 font-semibold text-sm uppercase tracking-wider mb-4">Testimonials</div>

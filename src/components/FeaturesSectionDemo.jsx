  ...
  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      ...
      <div className="relative">
        <div className="grid grid-cols-1 lg:grid-cols-6 mt-12 xl:border rounded-md dark:border-neutral-800 bg-background/50 backdrop-blur-sm">
    ...
    >
      <div className="w-full mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2 relative">
          ...
          <img
            src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3"
...
export const CobeGlobe = ({ className }) => {
